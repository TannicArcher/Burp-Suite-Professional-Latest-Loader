...
public class Filter
{
    ...
    public static byte[] BountyFilter(final String url, final byte[] data) throws NoSuchAlgorithmException, InvalidKeySpecException, SignatureException, InvalidKeyException {
        if (url.equals("https://api.licensespring.com/api/v4/activate_license")) {
            ...
            String json = getText(doSign, "hardware_id") + "#" + getText(doSign, "license_key") + "#9999-12-31t00:00:00.000z";
            json = "{\"license_signature\":\"" + getsign(json.toLowerCase()) + "\",\"license_type\":\"perpetual\",\"license_key\":\"EGYPT-EGYPT-EGYPT-EGYPT-EGYPT\",\"is_trial\":false,\"validity_period\":\"9999-12-31T00:00:00.000+00:00\",\"max_activations\":999999999,\"times_activated\":999999999,\"transfer_count\":999999999,\"prevent_vm\":false,\"customer\":{\"email\":\"TannicArcher\",\"first_name\":\"TannicArcher\",\"last_name\":\" \",\"company_name\":\"TannicArcher\",\"phone\":\"+1\",\"reference\":\"Egypt\"},\"product_details\":{\"product_name\":\"Burp Bounty Pro\",\"short_code\":\"burpbountyprostripe\",\"allow_trial\":false,\"trial_days\":0,\"authorization_method\":\"license-key\"},\"allow_overages\":false,\"max_overages\":0,\"is_floating_cloud\":false,\"floating_users\":0,\"floating_timeout\":0}\n";
        ...
        if (url.startsWith("https://api.licensespring.com/api/v4/check_license?app_name=Burp")) {
            final String doSign = getparam(url, "hardware_id") + "#" + getparam(url, "license_key") + "#9999-12-31t00:00:00.000z";
            final String json = "{\"license_signature\":\"" + getsign(doSign.toLowerCase()) + "\",\"license_type\":\"perpetual\",\"license_key\":\"EGYPT-EGYPT-EGYPT-EGYPT-EGYPT\",\"is_trial\":false,\"validity_period\":\"9999-12-31T00:00:00.000+00:00\",\"max_activations\":999999999,\"times_activated\":999999999,\"transfer_count\":999999999,\"prevent_vm\":false,\"customer\":{\"email\":\"TannicArcher",\"first_name\":\"TannicArcher\",\"last_name\":\" \",\"company_name\":\"TannicArcher\",\"phone\":\"+1\",\"reference\":\"Egypt\"},\"product_details\":{\"product_name\":\"Burp Bounty Pro\",\"short_code\":\"burpbountyprostripe\",\"allow_trial\":false,\"trial_days\":0,\"authorization_method\":\"license-key\"},\"allow_overages\":false,\"max_overages\":0,\"is_floating_cloud\":false,\"floating_users\":0,\"floating_timeout\":0,\"license_active\":true,\"license_enabled\":true,\"is_expired\":false}";
            return json.getBytes();
        }
        return null;
    }
    ...
    public static String getText(final String json, final String label) {
        ...
        if (start != -1) {
            final int end = json.indexOf(after, start += before.length());
